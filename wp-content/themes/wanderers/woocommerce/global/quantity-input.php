...
<?php } else {
    ...
    $label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'wanderers' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'wanderers' );
    ?>
    <div class="mkdf-quantity-buttons quantity">
        ...
        <input 
            ...
            title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'wanderers' ) ?>"
            size="4"
