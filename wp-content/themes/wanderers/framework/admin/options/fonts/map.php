...
if ( ! function_exists( 'wanderers_mkdf_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function wanderers_mkdf_fonts_options_map() {
		
		wanderers_mkdf_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'wanderers' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = wanderers_mkdf_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'wanderers' )
			)
		);
		
		//H1
		$group_heading_h1 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'wanderers' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'wanderers' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'wanderers' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h1_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'wanderers' ),
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'wanderers' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'wanderers' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'wanderers' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h2_2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h2_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'wanderers' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'wanderers' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h3_2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h3_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'wanderers' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'wanderers' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h4_2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h4_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'wanderers' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'wanderers' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h5_2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h5_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'wanderers' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'wanderers' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h6_2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$row_heading_h6_3 = wanderers_mkdf_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = wanderers_mkdf_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'wanderers' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'wanderers' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'wanderers' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'wanderers' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'wanderers' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'wanderers' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'wanderers' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = wanderers_mkdf_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = wanderers_mkdf_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'wanderers' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = wanderers_mkdf_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = wanderers_mkdf_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'wanderers' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = wanderers_mkdf_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = wanderers_mkdf_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = wanderers_mkdf_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = wanderers_mkdf_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'wanderers' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'wanderers' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Table Portrait View)', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for table devices - portrait view', 'wanderers' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'wanderers' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'wanderers' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'wanderers' ),
				'description' => esc_html__( 'Define styles for link text', 'wanderers' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'wanderers' ),
				'parent'        => $row_link_1
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'wanderers' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'wanderers' ),
				'options'       => wanderers_mkdf_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'wanderers' ),
				'options'       => wanderers_mkdf_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'wanderers_mkdf_options_map', 'wanderers_mkdf_fonts_options_map', 3 );
}