...
if ( ! function_exists('wanderers_mkdf_contact_form_7_options_map') ) {

	function wanderers_mkdf_contact_form_7_options_map() {
		
		wanderers_mkdf_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'wanderers' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = wanderers_mkdf_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'wanderers' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'wanderers' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'wanderers' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'wanderers' ),
			)
		);
		...
		$typography_text_row2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$typography_text_row3 = wanderers_mkdf_add_admin_row(
			array(
		...
		$typography_label_group = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'wanderers' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'wanderers' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$typography_label_row2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$background_border_group = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'wanderers' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'wanderers' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'wanderers' )
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'wanderers' )
			)
		);
		
		$background_border_row2 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'wanderers' ),
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'wanderers' )
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'wanderers' )
			)
		);
		
		$background_border_row3 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'wanderers' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'wanderers' ),
				'description' => esc_html__( 'Setup form elements margin', 'wanderers' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = wanderers_mkdf_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'wanderers' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'wanderers' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'wanderers' ),
				'description' => esc_html__( 'Setup button text typography', 'wanderers' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$button_typography_row2 = wanderers_mkdf_add_admin_row(
			array(
		...
		$button_background_border_group = wanderers_mkdf_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'wanderers' ),
				'description' => esc_html__( 'Setup button background and border style', 'wanderers' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'wanderers' )
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'wanderers' )
			)
		);
		
		$button_background_border_row2 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'wanderers' )
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'wanderers' )
			)
		);
		
		$button_background_border_row3 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'wanderers' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'wanderers' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = wanderers_mkdf_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'wanderers')
		));

		//Text Typography

		$typography_text_group = wanderers_mkdf_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'wanderers'),
			'description'	=> esc_html__('Setup typography for form elements text', 'wanderers'),
		...
		$typography_text_row1 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = wanderers_mkdf_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'wanderers'),
			'description'	=> esc_html__('Setup typography for form elements label', 'wanderers'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = wanderers_mkdf_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'wanderers'),
			'description'	=> esc_html__('Setup form elements background and border style', 'wanderers'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = wanderers_mkdf_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'wanderers'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = wanderers_mkdf_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'wanderers'),
			'description'	=> esc_html__('Setup form elements margin', 'wanderers'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = wanderers_mkdf_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'wanderers'),
			'description'	=> esc_html__('Setup button text typography', 'wanderers'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = wanderers_mkdf_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'wanderers'),
			'description'	=> esc_html__('Setup button background and border style', 'wanderers'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = wanderers_mkdf_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = wanderers_mkdf_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'wanderers')
        ));
        ...
        $typography_label_row3 = wanderers_mkdf_add_admin_row(array(
        ...
        $button_typography_row3 = wanderers_mkdf_add_admin_row(array(
		...
		$panel_contact_form_style_4 = wanderers_mkdf_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_4',
				'title' => esc_html__( 'Custom Style 4', 'wanderers' )
			)
		);
	...
	add_action( 'wanderers_mkdf_options_map', 'wanderers_mkdf_contact_form_7_options_map', 20);
}