...
if ( class_exists( 'WanderersCoreClassWidget' ) ) {
	...
	class WanderersMkdfClassIconsGroupWidget extends WanderersCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'mkdf_social_icons_group_widget',
				esc_html__( 'Mikado Social Icons Group Widget', 'wanderers' ),
				array( 'description' => esc_html__( 'Use this widget to add a group of up to 8 social icons to a widget area.', 'wanderers' ) )
			);
		...
		protected function setParams() {
			$this->params = array_merge(
				...
				wanderers_mkdf_icon_collections()->getSocialIconWidgetMultipleParamsArray( 8 ),
				array(
					array(
						'type'    => 'dropdown',
						'name'    => 'layout',
						'title'   => esc_html__( 'Icons Layout', 'wanderers' ),
						'options' => array(
							''             => esc_html__( 'Default', 'wanderers' ),
							'square-icons' => esc_html__( 'Square', 'wanderers' ),
						)
					),
					array(
						'type'        => 'dropdown',
						'name'        => 'skin',
						'title'       => esc_html__( 'Square Icons Skin', 'wanderers' ),
						'description' => esc_html__( 'This applies to the square layout', 'wanderers' ),
						'options'     => array(
							''           => esc_html__( 'Dark Skin', 'wanderers' ),
							'light-skin' => esc_html__( 'Light Skin', 'wanderers' ),
						)
					),
					array(
						'type'    => 'dropdown',
						'name'    => 'alignment',
						'title'   => esc_html__( 'Text Alignment', 'wanderers' ),
						'options' => array(
					...
					array(
						'type'  => 'textfield',
						'name'  => 'icon_size',
						'title' => esc_html__( 'Icons Size (px)', 'wanderers' )
					),
					array(
						'type'  => 'colorpicker',
						'name'  => 'color',
