...
if ( ! function_exists( 'wanderers_mkdf_get_hide_dep_for_header_main_menu_options' ) ) {
	function wanderers_mkdf_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'wanderers_mkdf_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'wanderers_mkdf_header_main_navigation_options_map' ) ) {
	function wanderers_mkdf_header_main_navigation_options_map() {
		$hide_dep_options = wanderers_mkdf_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = wanderers_mkdf_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'wanderers' ),
		...
		wanderers_mkdf_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'wanderers' )
			)
		);
		
		$drop_down_group = wanderers_mkdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'wanderers' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'wanderers' )
			)
		);
		
		$drop_down_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'wanderers' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'wanderers' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'wanderers' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'wanderers' )
				)
			)
		);
		...
		$first_level_group = wanderers_mkdf_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'wanderers' )
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'wanderers' ),
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'wanderers' ),
			)
		);
		
		$first_level_row4 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'wanderers' ),
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'wanderers' ),
			)
		);
		
		$first_level_row5 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'wanderers' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = wanderers_mkdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'wanderers' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'wanderers' )
			)
		);
		...
		wanderers_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'wanderers' )
			)
		);
		...
		$second_level_wide_group = wanderers_mkdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'wanderers' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'wanderers' )
			)
		);
		
		$second_level_wide_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$second_level_wide_row2 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = wanderers_mkdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3rd Level Menu', 'wanderers' ),
				'description' => esc_html__( 'Define styles for 3rd level in Top Navigation Menu', 'wanderers' )
			)
		);
		...
		$third_level_wide_group = wanderers_mkdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'wanderers' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'wanderers' )
			)
		);
		
		$third_level_wide_row1 = wanderers_mkdf_add_admin_row(
			array(
		...
		$third_level_wide_row2 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = wanderers_mkdf_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'wanderers_mkdf_header_main_navigation_options_map', 'wanderers_mkdf_header_main_navigation_options_map', 10, 1 );
}