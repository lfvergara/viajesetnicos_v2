...
class WanderersMkdfSimpleLineIcons implements iWanderersMkdfIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'wanderers'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'wanderers'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'wanderers'),
            'icon-social-facebook'    => esc_html__('Facebook', 'wanderers'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'wanderers'),
            'icon-social-github'      => esc_html__('Github', 'wanderers'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'wanderers'),
            'icon-social-instagram'   => esc_html__('Instagram', 'wanderers'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'wanderers'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'wanderers'),
            'icon-social-reddit'      => esc_html__('Reddit', 'wanderers'),
            'icon-social-skype'       => esc_html__('Skype', 'wanderers'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'wanderers'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'wanderers'),
            'icon-social-spotify'     => esc_html__('Spotify', 'wanderers'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'wanderers'),
            'icon-social-twitter'     => esc_html__('Twitter', 'wanderers'),
            'icon-social-youtube'     => esc_html__('Youtube', 'wanderers')
        );
    }
