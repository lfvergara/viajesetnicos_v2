...
/*
   Class: WanderersMkdfDashboardForm
   A class that initializes Mikado Dashboard Container
*/
class WanderersMkdfDashboardForm implements iWanderersMkdfLayoutNode, iWanderersMkdfRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: WanderersMkdfDashboardGroup
   A class that initializes WanderersMkdf Group Field
*/
class WanderersMkdfDashboardGroup implements iWanderersMkdfLayoutNode, iWanderersMkdfRender{
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: WanderersMkdfDashboardTitle
   A class that initializes Dashboard Title
*/
class WanderersMkdfDashboardTitle implements iWanderersMkdfRender {
	private $name;
	private $title;
...
/*
   Class: WanderersMkdfDashboardField
   A class that initializes WanderersMkdf Front Field
*/

class WanderersMkdfDashboardField implements iWanderersMkdfRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class WanderersMkdfDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class WanderersMkdfDashboardFieldText extends WanderersMkdfDashboardFieldType {
...
class WanderersMkdfDashboardFieldTextArea extends WanderersMkdfDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class WanderersMkdfDashboardFieldImage extends WanderersMkdfDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
			...
			<div class="mkdf-dashboard-gallery-holder">
				<ul class="mkdf-dashboard-gallery-images-holder">
					<?php if ( isset($value_html) ) { 
						print wanderers_mkdf_display_content_output($value_html);
					} ?>
				</ul>
				<div class="mkdf-dashboard-gallery-uploader">
					...
					if ( mkdf_membership_theme_installed() ) {
						echo wanderers_mkdf_get_button_html( array(
							'text'      => esc_html__( 'Upload', 'wanderers' ),
							'custom_class' => 'mkdf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" target="_self" class="mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-dashboard-gallery-upload"><span class="mkdf-btn-text">' . esc_html__( 'Upload', 'wanderers' ) . '</span></a>';
					} ?>
					...
					<?php if ($value !== '' && $value !== false) { ?>
						<button class="mkdf-btn mkdf-btn-solid mkdf-dashboard-remove-image"><?php esc_html_e('Remove Media','wanderers'); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class WanderersMkdfDashboardFieldGallery extends WanderersMkdfDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class WanderersMkdfDashboardFieldSelect extends WanderersMkdfDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class WanderersMkdfDashboardFieldDate extends WanderersMkdfFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class WanderersMkdfDashboardFieldIcon extends WanderersMkdfDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
...
class WanderersMkdfDashboardFieldColor extends WanderersMkdfDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class WanderersMkdfDashboardFieldCheckBoxGroup extends WanderersMkdfDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class WanderersMkdfDashboardFieldAddress extends WanderersMkdfFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class WanderersMkdfDashboardRepeater implements iWanderersMkdfRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ($this->table_layout) { ?>
				<div class="mkdf-dashboard-repeater-table-heading">
					<div class="mkdf-dashboard-repeater-fields-holder">
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'wanderers' ) ?></div>
						...
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'wanderers' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class WanderersMkdfDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array()) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new WanderersMkdfDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new WanderersMkdfDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new WanderersMkdfDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new WanderersMkdfDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new WanderersMkdfDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new WanderersMkdfDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new WanderersMkdfDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new WanderersMkdfDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new WanderersMkdfDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new WanderersMkdfDashboardFieldAddress();
