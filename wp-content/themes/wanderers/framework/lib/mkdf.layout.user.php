...
/*
   Class: WanderersMkdfUserField
   A class that initializes WanderersMkdf User Field
*/

class WanderersMkdfUserField implements iWanderersMkdfRender {
	private $type;
	private $name;
	private $label;
	private $description;
	...
	function __construct( $type, $name, $label = "", $description = "", $options = array(), $args = array() ) {
		...
		$this->args        = $args;
		add_filter( 'wanderers_mkdf_user_fields', array( $this, 'addFieldForEditSave' ) );
	}
...
abstract class WanderersMkdfUserFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array() );
}

class WanderersMkdfUserFieldText extends WanderersMkdfUserFieldType {
...
class WanderersMkdfUserFieldSelect extends WanderersMkdfTaxonomyFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array() ) {
...
/*
   Class: WanderersMkdfUserGroup
   A class that initializes Mikado User Group
*/
class WanderersMkdfUserGroup implements iWanderersMkdfLayoutNode, iWanderersMkdfRender {
	public $children;
	public $title;
	public $description;
...
class WanderersMkdfUserFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $hidden = false ) {

		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new WanderersMkdfUserFieldText();
				$field->render( $name, $label, $description, $options, $args, $hidden );
				break;
			case 'select':
				$field = new WanderersMkdfUserFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $hidden );
				break;
			default:
				break;
