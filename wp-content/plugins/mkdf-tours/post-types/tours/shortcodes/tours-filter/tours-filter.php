...
class ToursFilter implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			...
			'params'                    => array(
				...
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Filter Semi-Transparent', 'mkdf-tours'),
	...
	public function render($atts, $content = null) {
		...
		$params['display_container_inner'] = $params['filter_in_grid'] === 'yes' && $params['filter_type'] === 'horizontal';
		...
		return mkdf_tours_get_tour_module_template_part('tours-filter/templates/tours-filters-holder', 'tours', 'shortcodes', '', $params);
	}
}