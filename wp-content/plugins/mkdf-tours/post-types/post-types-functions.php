...
if(!function_exists('mkdf_tours_include_custom_post_types_meta_boxes')) {
	...
	add_action('wanderers_mkdf_before_meta_boxes_map', 'mkdf_tours_include_custom_post_types_meta_boxes');
}
...
if(!function_exists('mkdf_tours_include_custom_post_types_global_options')) {
	...
	add_action('wanderers_mkdf_before_options_map', 'mkdf_tours_include_custom_post_types_global_options', 1);
}