...
if ( ! function_exists( 'mkdf_tours_filter_suffix' ) ) {
	/**
	 ...
	 * @return string
	 */
	function mkdf_tours_filter_suffix( $value, $suffix ) {
		if ( $value !== '' && mkdf_tours_string_ends_with( $value, $suffix ) ) {
...
if ( ! function_exists( 'mkdf_tours_filter_px' ) ) {
	/**
	 ...
	 * @return string
	 *
	 * @see mkdf_tours_filter_suffix
	 */
	function mkdf_tours_filter_px( $value ) {
		return mkdf_tours_filter_suffix( $value, 'px' );
	}
}
...
if(!function_exists('mkdf_tours_get_checkout_pages')) {
	...
	function mkdf_tours_get_checkout_pages($first_empty = false) {
		...
		if($first_empty) {
			$search_pages[''] = esc_html__('No Selected', 'mkdf-tours');
		}
...
if(!function_exists('mkdf_tours_get_search_page_url')) {
	...
	function mkdf_tours_get_search_page_url() {
	    ...
	    $option = wanderers_mkdf_options()->getOptionValue('tours_search_main_page');
...
if(!function_exists('mkdf_tours_paypal_enabled')) {
	...
	function mkdf_tours_paypal_enabled() {
	    ...
	    if(mkdf_tours_theme_installed()) {
		    $option = wanderers_mkdf_options()->getOptionValue('tours_enable_paypal');
	    }
...
if(!function_exists('mkdf_tours_get_paypal_facilitator_id')) {
	...
	function mkdf_tours_get_paypal_facilitator_id() {
	    ...
	    if(mkdf_tours_theme_installed()) {
		    $option = wanderers_mkdf_options()->getOptionValue('paypal_facilitator_id');
	    }
...
if(!function_exists('mkdf_tours_get_paypal_currency')) {
	...
	function mkdf_tours_get_paypal_currency() {
	    ...
	    if(mkdf_tours_theme_installed()) {
		    $option = wanderers_mkdf_options()->getOptionValue('paypal_currency');
	    }
