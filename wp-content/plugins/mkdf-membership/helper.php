...
if ( ! function_exists( 'mkdf_membership_get_module_template_part' ) ) {
    /**
     ...
     * @return string
     */
    function mkdf_membership_get_module_template_part( $module, $submodule, $template, $slug = '', $params = array() ) {

        //HTML Content from template
        $html          = '';
        $template_path = MIKADO_MEMBERSHIP_ABS_PATH . '/modules/' . $module . '/' . $submodule .'/templates';
...
if ( ! function_exists( 'mkdf_membership_kses_img' ) ) {
	 ...
	 * Defines wanderers_mkdf_kses_img_atts filter that can be used for changing allowed html attributes
	 *
	 * @see wp_kses()
	 *
