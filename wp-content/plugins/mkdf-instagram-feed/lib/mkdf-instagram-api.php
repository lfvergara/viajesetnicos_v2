...
class MikadoInstagramApi {
	...
	const INSTAGRAM_CODE = 'mkdf_instagram_code';
	const INSTAGRAM_USER_ID = 'mkdf_instagram_user_id';
	const INSTAGRAM_TOKEN = 'mkdf_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'mkdf_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'mkdf_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'mkdf_facebook_code';
	const FACEBOOK_TOKEN = 'mkdf_facebook_access_token';

	const CONNECTION_TYPE = 'mkdf_connection_type';
