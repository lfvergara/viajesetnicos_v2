<?php
if ( ! function_exists( 'wanderers_mkdf_init_google_fonts_array' ) ) {
    function wanderers_mkdf_init_google_fonts_array() {
        ...
        $wanderers_mkdf_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'wanderers_mkdf_init_google_fonts_array');
}