...
if ( ! function_exists( 'wanderers_mkdf_get_button_html' ) ) {
	/**
	 ...
	 * @return mixed|string
	 */
	function wanderers_mkdf_get_button_html( $params ) {
		$button_html = wanderers_mkdf_execute_shortcode( 'mkdf_button', $params );
