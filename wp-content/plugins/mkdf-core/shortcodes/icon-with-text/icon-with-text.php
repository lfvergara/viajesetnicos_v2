...
class IconWithText implements Lib\ShortcodeInterface {
			...
			vc_map(
				array(
					...
					'params'                    => array_merge(
						...
						wanderers_mkdf_icon_collections()->getVCParamsArray(),
						array(
							array(
								'type'       => 'attach_image',
							...
							array(
								...
								'heading'    => esc_html__( 'Custom Hover Icon', 'mkdf-core' ),
							...
							array(
								...
								'value'      => array_flip( wanderers_mkdf_get_link_target_array() ),
	...
	public function render( $atts, $content = null ) {
		...
		$default_atts = array_merge( $default_atts, wanderers_mkdf_icon_collections()->getShortcodeParams() );
	...
	private function getIconParameters( $params ) {
		...
		if ( empty( $params['custom_icon'] ) ) {
			$iconPackName = wanderers_mkdf_icon_collections()->getIconCollectionParamNameByKey( $params['icon_pack'] );
			...
			if ( ! empty( $params['custom_icon_size'] ) ) {
				$params_array['custom_size'] = wanderers_mkdf_filter_px( $params['custom_icon_size'] ) . 'px';
			}
			...
			if ( ! empty( $params['shape_size'] ) ) {
				$params_array['shape_size'] = wanderers_mkdf_filter_px( $params['shape_size'] ) . 'px';
			}
			...
			if ( $params['icon_border_width'] !== '' ) {
				$params_array['border_width'] = wanderers_mkdf_filter_px( $params['icon_border_width'] ) . 'px';
			}
	...
	private function getContentStyles( $params ) {
		...
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-left' ) {
			$styles[] = 'padding-left: ' . wanderers_mkdf_filter_px( $params['text_padding'] ) . 'px';
		}
		
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-top' ) {
			$styles[] = 'padding-top: ' . wanderers_mkdf_filter_px( $params['text_padding'] ) . 'px';
		}
	...
	private function getTitleStyles( $params ) {
		...
		if ( $params['title_top_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . wanderers_mkdf_filter_px( $params['title_top_margin'] ) . 'px';
		}
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . wanderers_mkdf_filter_px( $params['text_top_margin'] ) . 'px';
		}
