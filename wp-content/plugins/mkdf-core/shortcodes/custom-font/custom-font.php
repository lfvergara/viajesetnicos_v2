...
class CustomFont implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array_flip( wanderers_mkdf_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => array_flip( wanderers_mkdf_get_font_weight_array( true ) ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							...
							'value'       => array_flip( wanderers_mkdf_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => array_flip( wanderers_mkdf_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( wanderers_mkdf_string_ends_with( $params['font_size'], 'px' ) || wanderers_mkdf_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( wanderers_mkdf_string_ends_with( $params['line_height'], 'px' ) || wanderers_mkdf_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( wanderers_mkdf_string_ends_with( $params['letter_spacing'], 'px' ) || wanderers_mkdf_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1280'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['font_size_1280'], 'px' ) || wanderers_mkdf_string_ends_with( $params['font_size_1280'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['font_size_1024'], 'px' ) || wanderers_mkdf_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['font_size_768'], 'px' ) || wanderers_mkdf_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['font_size_680'], 'px' ) || wanderers_mkdf_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1280'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['line_height_1280'], 'px' ) || wanderers_mkdf_string_ends_with( $params['line_height_1280'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['line_height_1024'], 'px' ) || wanderers_mkdf_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['line_height_768'], 'px' ) || wanderers_mkdf_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( wanderers_mkdf_string_ends_with( $params['line_height_680'], 'px' ) || wanderers_mkdf_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="mkdf-cf-typed-wrap" ' . wanderers_mkdf_get_inline_style( $typed_styles ) . '><span class="mkdf-cf-typed">';
