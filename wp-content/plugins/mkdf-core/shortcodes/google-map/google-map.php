				...
				array(
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Snazzy Map Style', 'mkdf-core' ),
							'value'       => array_flip( wanderers_mkdf_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option will set predefined snazzy map style', 'mkdf-core' )
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'snazzy_map_code',
							'heading'     => esc_html__( 'Snazzy Map Code', 'mkdf-core' ),
							'description' => sprintf( esc_html__( 'Fill code from snazzy map site %s to add predefined style for your google map', 'mkdf-core' ), '<a href="https://snazzymaps.com/" target="_blank">https://snazzymaps.com/</a>' ),
