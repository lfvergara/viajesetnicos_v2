<div class="mkdf-call-to-action-holder <?php echo esc_attr($holder_classes); ?>">
	<div class="mkdf-cta-inner <?php echo esc_attr($inner_classes); ?>">
		...
		<div class="mkdf-cta-button-holder" <?php echo wanderers_mkdf_get_inline_style($button_holder_styles); ?>>
			<div class="mkdf-cta-button"><?php echo wanderers_mkdf_get_button_html($button_parameters); ?></div>
		</div>
	</div>
</div>