...
namespace MikadoCore\CPT\Shortcodes\TopReviewsCarousel;
...
class TopReviewsCarousel implements ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'mkdf_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = mkdf_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Top Reviews Carousel', 'mkdf-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'mkdf-core' ),
						'description' => esc_html__( 'Leave empty for all', 'mkdf-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'mkdf-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return mkdf_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
